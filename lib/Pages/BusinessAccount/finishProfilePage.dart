                  ...
                  child: Container(
                    ...
                    child: TextFormField(
                        ...
                        validator: (value) {
                          String? message;
                          if (value!.isEmpty) {
                            message = "Business decription should not be empty";
                          }
                          return message;
                        },
                        ...
                        child: Column(
                          ...
                          children: [
                            SwitcherButton(
                              ...
                              onColor: const Color.fromARGB(255, 229, 143, 101),
                            ),
                            Padding(
                            ...
                            Padding(
                              ...
                              child: SwitcherButton(
                                onChange: (value) {
                                  setState(() {
                                    value
                                        ? _saturndaytext = const Color.fromARGB(
                                            255, 229, 143, 101)
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                "Monday",
                                style:
                                    TextStyle(fontSize: 16, color: _mondaytext),
                              ),
                            ),
                            Padding(
                              padding: const EdgeInsets.symmetric(
                ...
                Padding(
                  ...
                  child: RichText(
                      text: const TextSpan(
                          ...
                          children: [
                        TextSpan(
                            text: "(optional)", style: TextStyle(fontSize: 15))
                      ])),
                ),
                const Padding(
                  padding: EdgeInsets.only(top: 21, left: 15),
